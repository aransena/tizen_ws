...
void view1_stopButton_onclicked(uib_view1_view_context*, Evas_Object*, void*);
...
uib_view_context* uib_view1_view_create(Evas_Object* parent, void* create_callback_param) {
	...
	evas_object_smart_callback_add(vc->stopButton, "clicked", (Evas_Smart_Cb)view1_stopButton_onclicked, vc);
